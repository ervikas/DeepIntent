...
public class APKCallGraph {
	...
	public static void generateCallGraph(String apk, String apkPath, String ic3) throws IOException, XmlPullParserException {
		...
		app.calculateSourcesSinksEntrypoints("/home/vikas/Downloads/deepintent/DeepIntent-master/IconWidgetAnalysis/Static_Analysis/SourcesAndSinks.txt");
		soot.G.reset();
		...
		app.setCallbackFile("/home/vikas/Downloads/deepintent/DeepIntent-master/IconWidgetAnalysis/Static_Analysis/AndroidCallbacks.txt");
		...
		File file = new File("/home/vikas/Desktop/Static_Analysis/dot_output/" + apk + "/");
		file.mkdir();
		exporter.exportGraph(jg, new FileWriter("/home/vikas/Desktop/Static_Analysis/dot_output/" + apk + "/" + apk + ".dot"));
	}
	 ...
	 public static void generateSubGraphOfMethod(String apk, String method) throws IOException, SQLException {
		...
		if(!methods.containsKey(method)){
			...
			DOTExporter<MethodNode, CallEdge> exporter = new DOTExporter<MethodNode, CallEdge>(
					apkg.new MethodnodeIdProvider(), apkg.new MethodNodeNameProvider(), null);
			exporter.exportGraph(subGraph, new FileWriter("/home/vikas/Desktop/Static_Analysis/dot_output/" + apk + "/" + method + ".dot"));
	...
	public static String getPermission(String method) throws SQLException{
		...
		String url = "jdbc:mysql://localhost:3306/APKCalls?user=vikas&password=abcd1234#&serverTimezone=GMT";
		try {
